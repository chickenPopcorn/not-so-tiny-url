...
describe('Rank', function() {
    ...
    it('should return the number of clicks for a given shortUrl saved in Redis',
        function(done) {
            var tinyUrl = 'a';
            rankUrlService.getUrlClicksCached(tinyUrl,
    ...
    it('should update the number of clicks for a given shortUrl saved in Redis',
        function(done) {
            var tinyUrl = 'a';
            rankUrlService.getUrlClicks(tinyUrl, function(shortUrl, data) {
                var prev = shortUrl;
                rankUrlService.updateUrlClicks(shortUrl,
                    function(shortUrl, data) {
